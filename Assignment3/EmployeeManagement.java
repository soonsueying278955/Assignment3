...
public class EmployeeManagement extends JFrame {
	...
	public EmployeeManagement() {
		...
		lblEmployeeManagement.setBounds(349, 0, 601, 113);
		...
		btnUpload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					File file = new File("C:\\Users\\User\\Documents\\A202\\STIA 1123 PROGRAMMING 2\\Assignment\\Assignment3 - txt files\\Employee Management.txt");
					if(!file.exists()) {
						file.createNewFile();
					}
